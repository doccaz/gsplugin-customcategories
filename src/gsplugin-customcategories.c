...
//   //gs_category_add_desktop_group(category, "X-Aplicativos");
...
//   //gs_category_add_desktop_group(sub, "X-SuSE-YaST::X-SuSE-YaST-Virtualization");
//   //gs_category_add_desktop_group(category, "Science");
//   gs_category_set_name(sub, "Categoria da Biba");
//   gs_category_add_child(category, sub);

//   for (int i = 0; i < category->desktop_groups->len; i++) {
//           const gchar *tmp = g_ptr_array_index (category->desktop_groups, i);
//           printf("[customcategories] category %s group %s\n", gs_category_get_name(category), tmp);
//   }
...
//   {
//     g_autoptr(GPtrArray) cats = gs_app_get_categories(app);
//     g_autoptr(GsCategory) category;
//     const gchar *catname;
//     printf("app = %s\n", gs_app_to_string(app));
...
//       category = (GsCategory *) g_ptr_array_index(cats, i);
//       printf("[customcategories] category name = %d\n", gs_category_get_id);
//       //if (g_strcmp0("X-SuSE-YaST", gs_category_get_name(cat)) == 0)
//       //{
